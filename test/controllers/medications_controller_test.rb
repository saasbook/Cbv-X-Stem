...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post medications_url, params: { medication: { days: @medication.days, description: @medication.description, directions: @medication.directions, provider: @medication.provider, user_holder_id: @medication.user_holder_id } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { days: @medication.days, description: @medication.description, directions: @medication.directions, provider: @medication.provider, user_holder_id: @medication.user_holder_id } }
