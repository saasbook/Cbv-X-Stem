...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post treatments_url, params: { treatment: { description: @treatment.description, location: @treatment.location, provider: @treatment.provider, status: @treatment.status, user_holder_id: @treatment.user_holder_id } }
  #   end
  #
  ...
  #   patch treatment_url(@treatment), params: { treatment: { description: @treatment.description, location: @treatment.location, provider: @treatment.provider, status: @treatment.status, user_holder_id: @treatment.user_holder_id } }
